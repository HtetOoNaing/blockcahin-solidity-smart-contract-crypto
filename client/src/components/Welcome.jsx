        ...
        <div className="flex flex-1 justify-start flex-col md:mr-10">
          ...
          {!currentAccount && (
            <button
              ...
              className="flex flex-row justify-center items-center mt-5 bg-[#2952e3] p-3 rounded-full cursor-pointer hover:bg-[#2546bd]"
            >
          ...
          <div className="p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism">
            ...
            {isLoading ? (
              ...
              <button
                ...
                className="text-white mt-2 w-full border border-[#3d4f7c] p-2 rounded-full cursor-pointer"
              >
                Send Now
              </button>
            )}
